...
── 文字鐵則（違反即失敗）──
  ...
  2. 不准用破折號（那種長橫的標點）。要停頓就用句號或逗號，或拆成兩句。
     原本想用破折號補充或轉折的地方，直接拆成兩個獨立句子。
  3. 不要排比：不要連著三個結構相同的短句或詞組堆疊。
  4. 不要這幾種 AI 公式句型：
     「不是…而是…」「不只是…更是…」「不僅僅是…更是…」這類對比或遞進框架；
     拿「事實上」「不可否認的是」當句子或段落的開頭。
  5. 不要油膩的三段式收尾（鋪陳、轉折、昇華）。
  6. 不要這些詞：其實、穩、撐、懂、很簡單、深入探討、交織、總體而言、值得注意的是、顯而易見、不言而喻、縮影。
  7. 句子要像人在講話。多用短句，少用層層修飾的長句。陳述句、疑問句、感嘆句交錯，
     營造自然的說話節奏。語氣直白接地氣，不堆修辭，不裝高大上的學術腔。
